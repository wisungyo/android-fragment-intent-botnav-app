...
import kotlinx.android.synthetic.main.fragment_implicit.*
 ...
 * Use the [ImplicitFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ImplicitFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn_implicit.setOnClickListener {
            number = et_implicit_username.text.toString()
            message = et_implicit_password.text.toString()
...
//            sendWhatsapp(message)
    ...
    private fun sendWhatsapp(number: String, message: String) {
        val url = "https://wa.me/${number}?text=${message}"
    ...
    companion object {
         ...
         * @return A new instance of fragment ImplicitFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ImplicitFragment().apply {
